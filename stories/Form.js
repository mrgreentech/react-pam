      ...
      <Grid>
        <Unit default={'1-1'} medium={'1-2'}>
          <Fieldset mode={'column'} legend={'Text and select'}>
            ...
            <Field id={'input-name'} name={'name'} type={'text'} placeholder={'John Doe'} fluid={true}/>
            <label htmlFor="input-email">Email</label>
            <Field id={'input-email'} name={'email'} type={'email'} placeholder={'john@doe.com'} fluid={true}/>
            <label htmlFor="input-password">Password</label>
            <Field id={'input-password'} name={'name'} type={'password'} placeholder={'suPerS3cr37'} fluid={true}/>
            <label htmlFor="select-geek">Choose geek level</label>
            <Field id={'select-geek'} name={'geek'} component={'select'} fluid={true}>
        ...
        <Unit default={'1-1'} medium={'1-2'}>
          <Fieldset mode={'column'} legend={'Checkboxes'}>
            ...
            <label>
              <Field type={'radio'} name={'options'} value={'hipster'} defaultChecked={true}/> Hipster
            </label>
            <label>
          ...
          <Fieldset mode={'column'} legend={'Misc'}>
            ...
            <Field id={'input-color'} name={'color'} type={'color'} fluid={true}/>
            <label htmlFor="input-range">Range</label>
            <Field id={'input-range'} name={'range'} type={'range'} min={-5} max={5} fluid={true} list={'tickmarks'}/>
